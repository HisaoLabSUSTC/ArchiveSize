...
arcs = [1,1];%[1,1;2,1;2,10];%[1,1; 2,1; 2,2; 2,5; 2,10;2,20; 3,1];%[1,1; 2,1; 2,2; 2,5; 2,10;2,20; 3,1];

%folder = "/home/vmuser/Dataset/Update/";
folder = "/home/vmuser/server/dataset/ArchiveSize_Revision";
loadfolder = "/home/vmuser/Dataset/ArchiveSize";
...
%             end
            ...
            for arcsiz = [1,1,2,5,10,20,50,100,200,500,1000,2000]*pop
                clear task
                n=0;
                ...
                parfor i = 1:63
                    ...
                    data = load(sprintf("%s/Data/%s",loadfolder,name));
                    para = task(index).para;
                    arcst = ArchiveStrategy(para{1}, para{2}, para{3}, para{4});
                    arcst.removalMethod=removalMethod;
                    arcst.truncationMethod=truncationMethod;
