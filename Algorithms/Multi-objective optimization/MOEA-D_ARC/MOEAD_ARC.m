    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Population)
                ...
                rec(n).time = toc(startTime);
                rec(n).population = Population.objs;
                rec(n-1).offspring = Offsprings.objs;
                rec(n).FE = Problem.FE;
            end
           save(sprintf('/home/vmuser/Dataset/ArchiveSize/Data/MOEAD_PBI_%s_N%d_M%d_%d.mat', class(Problem), Problem.N, Problem.M, index),"rec");
